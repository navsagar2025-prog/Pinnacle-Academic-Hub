export default function Slide14SecLive() {
  return (
    <div className="w-screen h-screen overflow-hidden relative bg-primary">
      ...
      <div className="absolute inset-0 px-[10vw] flex flex-col justify-center">
        ...
        <h2
          className="font-display text-white text-[6vw] font-bold tracking-tight leading-tight mb-[0.5vh]"
        >
          Live Classes
        </h2>
        <h2
          className="font-display text-accent text-[6vw] font-bold tracking-tight leading-tight mb-[4vh]"
        >
          & Recordings
        </h2>
        <div className="w-[8vw] h-[3px] bg-teal mb-[3.5vh]" />
        <p className="font-body text-[2vw]" style={{ color: "rgba(255,255,255,0.6)" }}>
          Powered by Zoom — the platform Indian educators already trust
        </p>
      </div>
    </div>
  );
