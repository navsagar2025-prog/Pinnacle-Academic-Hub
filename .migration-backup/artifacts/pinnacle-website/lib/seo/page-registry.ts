...
export const PUBLIC_PAGES: PageSeoEntry[] = [
  ...
  },
  {
    ...
    description: "Apply to Pinnacle Academic Classes, Gaur City 2, Greater Noida. JEE, NEET, and board exam coaching for 2026–27. Free demo class — book your seat today.",
    hasOgTitle: true,
    hasOgDescription: true,
    hasOgUrl: true,
    hasOgImage: true,
