...
- **Seeded content**: 202 original MCQ questions (Physics 55, Chemistry 49, Mathematics 47, Biology 51) covering NCERT/JEE/NEET topics with 4 options, correct answer, solution, difficulty (easy/medium/hard), class grade (11/12), and some PYQ-style year tags. Seed script: `pnpm --filter @workspace/db run seed-questions` (`lib/db/src/seed-questions.ts`). Bulk import also available at `POST /api/v1/question-bank/import`.
