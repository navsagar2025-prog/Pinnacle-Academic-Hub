...
CREATE TYPE "public"."promo_audience" AS ENUM('public', 'student', 'both');--> statement-breakpoint
CREATE TYPE "public"."promo_display_type" AS ENUM('banner', 'popup');--> statement-breakpoint
...
CREATE TABLE "promotions" (
	...
	"title" text NOT NULL,
	"body" text NOT NULL,
	"display_type" "promo_display_type" DEFAULT 'banner' NOT NULL,
	"audience" "promo_audience" DEFAULT 'public' NOT NULL,
	"starts_at" timestamp NOT NULL,
	"ends_at" timestamp NOT NULL,
	"cta_label" text,
	"cta_url" text,
	"bg_colour" text DEFAULT '#1a2e5a' NOT NULL,
	"cta_colour" text DEFAULT '#2a9d8f' NOT NULL,
	"created_by_id" uuid,
	"archived_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
...
--> statement-breakpoint
CREATE TABLE "social_teacher_access" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" uuid NOT NULL,
	"platforms_allowed" jsonb DEFAULT '[]'::jsonb NOT NULL,
...
ALTER TABLE "promotions" ADD CONSTRAINT "promotions_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "social_posts" ADD CONSTRAINT "social_posts_posted_by_user_id_users_id_fk" FOREIGN KEY ("posted_by_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "social_posts" ADD CONSTRAINT "social_posts_approved_by_user_id_users_id_fk" FOREIGN KEY ("approved_by_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "social_teacher_access" ADD CONSTRAINT "social_teacher_access_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "attendance_student_date_subject_uniq" ON "attendance" USING btree ("student_id","date","subject");--> statement-breakpoint
CREATE UNIQUE INDEX "audit_logs_reminder_dedup_idx" ON "audit_logs" USING btree ("action","entity_type","entity_id",(details->>'date')) WHERE action = 'fee_reminder_sent' AND entity_type = 'fee_record' AND details->>'date' IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "audit_logs_confirmation_dedup_idx" ON "audit_logs" USING btree ("action","entity_type","entity_id") WHERE action = 'fee_confirmation_sent' AND entity_type = 'fee_record';--> statement-breakpoint
CREATE INDEX "health_snapshots_created_at_idx" ON "health_snapshots" USING btree ("created_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "psa_set_batch_unique_idx" ON "practice_set_assignments" USING btree ("set_id","batch_id") WHERE "practice_set_assignments"."batch_id" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "psa_set_student_unique_idx" ON "practice_set_assignments" USING btree ("set_id","student_id") WHERE "practice_set_assignments"."student_id" IS NOT NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "social_accounts_platform_uq" ON "social_accounts" USING btree ("platform");--> statement-breakpoint
...
CREATE INDEX "social_posts_posted_by_idx" ON "social_posts" USING btree ("posted_by_user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "social_teacher_access_user_uq" ON "social_teacher_access" USING btree ("user_id");