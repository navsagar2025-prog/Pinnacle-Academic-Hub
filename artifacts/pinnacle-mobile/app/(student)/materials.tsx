...
const materials = [
  ...
  {
    subject: "Mathematics",
    title: "Integral Calculus — Practice Set",
    type: "PDF",
    size: "3.1 MB",
    date: "16 Apr",
  },
  {
    subject: "Physics",
    title: "Wave Optics — Formulae Sheet",
    type: "PDF",
    size: "0.9 MB",
    date: "14 Apr",
  },
  {
    subject: "Chemistry",
    title: "Periodic Table — Extended Reference",
    type: "PDF",
    size: "1.2 MB",
    date: "12 Apr",
  },
...
export default function StudentMaterials() {
  ...
  const filtered =
    filter === "All" ? materials : materials.filter((m) => m.subject === filter);

  const handleDownload = () => {
    Alert.alert(
      "Demo Mode",
      "Downloads are disabled in the demo. Available in the live platform.",
      [{ text: "OK" }]
    );
  };
        ...
        >
          <View
            style={[
              ...
              {
                backgroundColor:
                  (subjectColor[m.subject] ?? colors.primary) + "18",
                borderRadius: 8,
              },
            ]}
          >
            <Feather
              name="file-text"
              size={20}
              color={subjectColor[m.subject] ?? colors.primary}
            />
          </View>
