                ...
                <div key={c.id} className="card hover:shadow-elevated transition-all flex flex-col">
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-500">
                      <span className="badge bg-[var(--color-navy)]/5 text-slate-600">{c.duration}</span>
                      <span className="text-slate-400 truncate">{c.eligibility}</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[var(--color-slate-light)] rounded-xl p-4 mb-4">
                    ...
                    <div className="flex justify-between items-center text-sm mb-2">
                      ...
                      <span className="font-semibold text-[var(--color-teal)]">₹{Math.ceil(c.fee / 12).toLocaleString("en-IN")}/mo</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-slate-400">Admission Fee (one-time)</span>
                      <span className="font-semibold text-slate-600">₹{ADMISSION_FEE.toLocaleString("en-IN")}</span>
                    </div>
                    <div className="border-t border-slate-200 mt-3 pt-3 flex justify-between">
                      ...
                      <span className="font-bold text-[var(--color-teal)]">₹{(c.fee + ADMISSION_FEE).toLocaleString("en-IN")}</span>
                    </div>
                  </div>
                  ...
                  <Link href="/admissions" className="btn-primary py-2.5 text-sm text-center mt-auto justify-center">
                    Apply Now
                  </Link>
                </div>
              ))}
