...
const SECTIONS = [
  ...
  { title: "3. Refund Process", body: "Refund requests must be submitted in writing to the accounts office or via email to team@paconline.in within the eligible period. Refunds are processed within 15 working days via NEFT/RTGS to the payer's bank account." },
  ...
  { title: "8. Contact for Refunds", body: "Accounts Office: team@paconline.in · +91 99718 62138 · Office hours: Mon–Sat, 10 AM – 5 PM" },
];
