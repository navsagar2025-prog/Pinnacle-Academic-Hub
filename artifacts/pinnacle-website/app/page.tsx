  ...
  const reasons = [
    {
      ...
      description:
        "IIT/NIT alumni and PhD-qualified faculty with 7–14 years of focused coaching experience.",
      color: "navy",
    },
    {
      ...
      description:
        "85+ IIT & AIIMS selections, 320+ NIT/state medical seats in 2024. Our results speak.",
      color: "teal",
    },
    {
      ...
      description:
        "Faculty-prepared notes, practice papers, and previous year question banks. All included.",
      color: "maroon",
    },
    {
      icon: <Clock size={24} />,
      ...
      description:
        "Morning and evening batches to fit school schedules. Weekend batches for working parents.",
      color: "gold",
    },
    {
      icon: <Award size={24} />,
      ...
      description:
        "Full-length mock tests with detailed performance analytics every 2 weeks. Just like the real exam.",
      color: "teal",
    },
    {
      icon: <Video size={24} />,
      ...
      description:
        "Never miss a class — all sessions are recorded and available for revision anytime in the student portal.",
      color: "navy",
    },
  ];
          ...
          {FACULTY.slice(0, 6).map((f) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold font-[family-name:var(--font-playfair)]">
                    {f.name}
                  </h3>
                  <div className="text-[var(--color-gold)] text-xs font-medium mt-0.5">
                    {f.designation}
                  </div>
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {f.teaches.split(" · ").map((t) => (
                    <span
                      key={t}
                      className="bg-[var(--color-teal)]/15 text-[var(--color-teal-light)] text-xs px-2 py-0.5 rounded-full"
                    >
                      {t}
                    </span>
                  ))}
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TOPPERS.map((t) => (
            <div
              key={t.name}
              className="card border-l-4 border-l-[var(--color-gold)] hover:shadow-elevated transition-all"
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-[var(--color-navy)] font-[family-name:var(--font-playfair)]">
                    {t.name}
                  </h3>
