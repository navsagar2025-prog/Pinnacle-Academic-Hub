        ...
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-4">
            ...
            {[
              ...
              { title: "3. Refund Process", body: "Refund requests must be submitted in writing to the accounts office or via email to accounts@pinnacleacademic.in within the eligible period. Refunds are processed within 15 working days via NEFT/RTGS to the payer's bank account." },
              ...
              { title: "8. Contact for Refunds", body: "Accounts Office: accounts@pinnacleacademic.in · +91 98765 43210 · Office hours: Mon–Sat, 10 AM – 5 PM" },
            ].map((s) => (
