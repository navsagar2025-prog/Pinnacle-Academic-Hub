        ...
        <section className="py-12 bg-white">
          <div className="max-w-4xl mx-auto px-4 prose prose-slate max-w-none">
            {[
              ...
              { title: "5. Data Retention", body: "We retain student records for a minimum of 5 years after the end of your enrolment for academic and legal purposes. You may request deletion of your data by contacting us at info@pinnacleacademic.in." },
              ...
              { title: "7. Your Rights", body: "You have the right to access, update, or delete your personal data. You may also opt out of marketing communications at any time. To exercise these rights, contact us at info@pinnacleacademic.in or +91 98765 43210." },
              { title: "8. Contact Us", body: "For privacy-related queries, contact: KCK Corporate Services Pvt. Ltd., Plot No. 45, Knowledge Park II, Greater Noida, UP 201306 · info@pinnacleacademic.in · +91 98765 43210" },
            ].map((s) => (
