      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-100">
          ...
          <div>
            ...
            <div className="text-[var(--color-teal)] text-xs font-medium">Student Portal</div>
          </div>
        </div>
        ...
        <div className="px-5 py-4 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <div className="text-[var(--color-navy)] font-semibold text-sm truncate">
                {user?.fullName ?? "Student"}
              </div>
              <div className="text-slate-400 text-xs">Student Account</div>
            </div>
          </div>
        </div>
