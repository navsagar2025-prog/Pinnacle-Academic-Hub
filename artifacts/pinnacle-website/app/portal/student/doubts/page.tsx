...
export const metadata = { title: "Doubts — Student Portal" };
...
export default async function StudentDoubtsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-[family-name:var(--font-playfair)] text-2xl font-bold text-[var(--color-navy)]">Ask a Doubt</h1>
        <p className="text-slate-500 text-sm mt-1">Stuck on a problem? Post your doubt and our teachers will reply within 24 hours.</p>
      </div>
