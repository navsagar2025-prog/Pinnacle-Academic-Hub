...
export const metadata = { title: "Practice Set — Admin Panel" };

export default async function AdminPracticeSetDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      <Link href="/portal/admin/practice-sets" className="inline-flex items-center gap-1 text-xs text-slate-500 hover:text-[var(--color-teal)]">
